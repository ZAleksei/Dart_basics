...
main() {
 ...
 print("В строке \"$strText\" найти цифры, разделитель пробел ${w.findNum(strText)} " );
 ...
 print( "Площадь треугольнтка a,b,c ${a},${b},${c}  равно ${Point.areaOfTriangle(a, b, c)} ");
...
// #region Задание 8
 ...
 final User u1= User("u1")
   ..email="u1@mail.ru";
  users.add(u1);
  users.printAllUsers();

  final User u2= User("u2")
  ..email="u2@mail.ru";
  users.add(u2);
  users.printAllUsers();

  final User u3= AdminUser("u3")
  ..email="u3@gmail.com";
  users.add(u3);
  users.printAllUsers();
